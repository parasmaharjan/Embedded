...
#include "define.h"				/* Include device specific declareation file here */
...
#define	CS_H()	PTM  |= PIN4	/* Set MMC_CS "high" */
#define CS_L()	PTM  &= ~PIN4	/* Set MMC_CS "low" */
#define CK_H()	PTS  |= PIN6	/* Set MMC_SCLK "high" */
#define	CK_L()	PTS  &= ~PIN6	/* Set MMC_SCLK "low" */
#define DI_H()	PTS  |= PIN5	/* Set MMC_DI "high" */
#define DI_L()	PTS  &= ~PIN5	/* Set MMC_DI "low" */
#define DO		PTS & PIN4	/* Test for MMC_DO ('H':true, 'L':false) */
